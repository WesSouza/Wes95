export enum Icons {
  ...
  toolbarFontDecrease = 'toolbarFontDecrease',
  toolbarFontIncrease = 'toolbarFontIncrease',
  toolbarHome = 'toolbarHome',
  toolbarOpen = 'toolbarOpen',
  toolbarPaste = 'toolbarPaste',
  toolbarReload = 'toolbarReload',
...
export const IconSrcs: Record<Icons, Record<IconSizes, string>> = {
  ...
  [Icons.fileTypeHtml]: {
    [IconSizes.small]: require('../assets/fileTypeHtmlSmall.png'),
    [IconSizes.large]: require('../assets/fileTypeHtmlLarge.png'),
  },
  [Icons.fileTypeJpeg]: {
  ...
  [Icons.toolbarCopy]: {
    [IconSizes.small]: require('../assets/toolbarCopySmall.png'),
    [IconSizes.large]: require('../assets/toolbarCopySmall.png'),
  },
  [Icons.toolbarCut]: {
    [IconSizes.small]: require('../assets/toolbarCutSmall.png'),
    [IconSizes.large]: require('../assets/toolbarCutSmall.png'),
  },
  [Icons.toolbarFavoriteAdd]: {
    [IconSizes.small]: require('../assets/toolbarFavoriteAddSmall.png'),
    [IconSizes.large]: require('../assets/toolbarFavoriteAddSmall.png'),
  },
  [Icons.toolbarFavorites]: {
    [IconSizes.small]: require('../assets/toolbarFavoritesSmall.png'),
    [IconSizes.large]: require('../assets/toolbarFavoritesSmall.png'),
  },
  [Icons.toolbarFontDecrease]: {
    [IconSizes.small]: require('../assets/toolbarFontDecreaseSmall.png'),
    [IconSizes.large]: require('../assets/toolbarFontDecreaseSmall.png'),
  },
  [Icons.toolbarFontIncrease]: {
    [IconSizes.small]: require('../assets/toolbarFontIncreaseSmall.png'),
    [IconSizes.large]: require('../assets/toolbarFontIncreaseSmall.png'),
  },
  [Icons.toolbarHome]: {
    [IconSizes.small]: require('../assets/toolbarHomeSmall.png'),
    [IconSizes.large]: require('../assets/toolbarHomeSmall.png'),
  },
  [Icons.toolbarOpen]: {
    [IconSizes.small]: require('../assets/toolbarOpenSmall.png'),
    [IconSizes.large]: require('../assets/toolbarOpenSmall.png'),
  },
  [Icons.toolbarPaste]: {
    [IconSizes.small]: require('../assets/toolbarPasteSmall.png'),
    [IconSizes.large]: require('../assets/toolbarPasteSmall.png'),
  },
  [Icons.toolbarReload]: {
    [IconSizes.small]: require('../assets/toolbarReloadSmall.png'),
    [IconSizes.large]: require('../assets/toolbarReloadSmall.png'),
  },
  [Icons.toolbarStop]: {
    [IconSizes.small]: require('../assets/toolbarStopSmall.png'),
    [IconSizes.large]: require('../assets/toolbarStopSmall.png'),
  },
};
