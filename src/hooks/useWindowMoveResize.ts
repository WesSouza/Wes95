...
import { getBoundingClientRect, getPointerCoords } from '~/src/utils/dom';
...
type Handlers<T> = Record<Elements, (event: PointerEvent<T>) => void>;
...
>({
  ...
  onMoveResizeEnd?: (coords: ObjectPosition) => void;
  resizeMaximum: Nullable<ObjectSize>;
  resizeMinimum: Nullable<ObjectSize>;
